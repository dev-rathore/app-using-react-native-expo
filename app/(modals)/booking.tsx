  ...
  return (
    <BlurView intensity={70} style={styles.container} tint="light">
      ...
      <View style={styles.card}>
        ...
        {openCard == 1 && (
          <Animated.View style={styles.datePickerCardBody}>
            <DatePicker
              options={{
                mainColor: Colors.common.dark,
                ...
                >
                  <TouchableOpacity
                    ...
                    <Ionicons
                      ...
                      size={26}
                      color={groups[index].count > 0 ? Colors.common.gray : '#cdcdcd'}
                    />
                  </TouchableOpacity>
                  <Text
                    style={{
                  ...
                  <TouchableOpacity
                    ...
                    <Ionicons name="add-circle-outline" size={26} color={Colors.common.gray} />
                  </TouchableOpacity>
                </View>
              </View>
            ))}
